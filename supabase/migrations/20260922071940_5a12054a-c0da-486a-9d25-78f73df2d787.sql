ALTER TABLE public.orders ADD COLUMN IF NOT EXISTS paid_method text;
...
BEGIN
  ...
  VALUES (_phone, 'deduction', 'confirmed', _amount, 0, new_balance, COALESCE(NULLIF(_note, ''), 'Paid for order ' || _reference));
